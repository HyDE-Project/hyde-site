...
:::caution
**Не** використовуйте `python-env install pyamdgpuinfo` для опційних extras — це додало б пакет як звичайну залежність і могло б спричинити конфлікт із майбутніми оновленнями HyDE. Завжди використовуйте `uv sync --extra <name>` для оголошених extras.
:::
