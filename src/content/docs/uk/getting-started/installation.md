...
Клонуйте репозиторій і перейдіть у каталог зі скриптами. Потім переконайтеся, що користувач має права на запис і виконання для клонованого каталогу
...
- кожен розділ також можна виконати окремо:
