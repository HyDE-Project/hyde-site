---
title: NVIDIA
description: Для користувачів графічних процесорів NVIDIA
---

Встановлення HyDE автоматизує встановлення **драйверів NVIDIA** та **nvidia-utils**.

:::note
Докладніше на: https://wiki.archlinux.org/title/NVIDIA

:::

Ця таблиця показує, які драйвери буде додано до вашої системи залежно від наявного у вас GPU NVIDIA.
