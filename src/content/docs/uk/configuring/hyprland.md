...
- [Базова конфігурація](#1-boilerplate)
- [Перевизначення](#2-overrides)
- [Користувацькі налаштування](#3-users)
...
Також дивіться [Поширені запитання та поради](../../help/faq#how-can-i-change-keyboard-layout).
