---
title: NVIDIA
description: Для пользователей графических процессоров NVIDIA
---

Установка HyDE автоматизирует установку драйверов **NVIDIA** и **nvidia-utils**.

:::note
Больше информации по адресу: https://wiki.archlinux.org/title/NVIDIA

:::

Эта таблица показывает, какие драйверы будут добавлены в вашу систему в зависимости от вашего графического процессора NVIDIA.
