---
title: HyDE गैलरी
description: समर्थित HyDE थीम्स
sidebar:
  order: 1
---
...
| थीम                                                                                                                                                                 | विवरण                                                                                  | लेखक                                                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| [![Vanta Black](https://placehold.co/180x50/000000/FFFFFF?text=Vanta+Black&font=Oswald)](https://github.com/rishav12s/Vanta-Black)                                 | सबसे गहरे काले रंग से प्रेरित Vanta Black थीम                                           | [rishav12s](https://github.com/rishav12s)                   |
| [![Bad Blood](https://placehold.co/180x50/030000/DF1010?text=Bad+Blood&font=Oswald)](https://github.com/HyDE-Project/hyde-gallery/tree/Bad-Blood)                  | लाल और काले रंग पर आधारित थीम                                                          | [HyDE-Project](https://github.com/HyDE-Project)             |
| [![Greenify](https://placehold.co/180x50/0e120f/295233?text=Greenify&font=Oswald)](https://github.com/mahaveergurjar/Theme-Gallery/tree/Greenify)                  | HyDE के लिए डार्क ग्रीन पर आधारित थीम                                                  | [mahaveergurjar](https://github.com/mahaveergurjar)         |
| [![Another World](https://placehold.co/180x50/11111B/6AA9C9?text=Another+World&font=Oswald)](https://github.com/cyb3rgh0u1/Another-World)                          | क्षितिज के पार एक कदम, जहाँ कल्पना सर्वोच्च है                                            | [cyb3rgh0u1](https://github.com/cyb3rgh0u1)                 |
| [![Hack the Box](https://placehold.co/180x50/061234/50AA09?text=Hack+the+Box&font=Oswald)](https://github.com/HyDE-Project/hyde-gallery/tree/Hack-the-Box)         | हैकर-प्रेरित थीम                                                                       | [T-Crypt](https://github.com/T-Crypt)                       |
| [![Oxo Carbon](https://placehold.co/180x50/161616/EE5396?text=Oxo+Carbon&font=Oswald)](https://github.com/rishav12s/Oxo-Carbon)                                    | HyDE के लिए Oxo Carbon पर आधारित थीम                                                  | [rishav12s](https://github.com/rishav12s)                   |
| [![Decay Green](https://placehold.co/180x50/14161E/95D3AF?text=Decay+Green&font=Oswald)](https://github.com/HyDE-Project/hyde-themes/tree/Decay-Green)             | आधिकारिक थीम                                                                          | [prasanthrangan](https://github.com/prasanthrangan)         |
| [![Abyssal-Wave](https://placehold.co/180x50/16161D/C8C093?text=Abyssal-Wave&font=Oswald)](https://github.com/Itz-Abhishek-Tiwari/Abyssal-Wave)                    | अंधकार की गहराइयों में, जहाँ सुंदरता अनंत रात्रि से मिलती है                           | [Itz-Abhishek-Tiwari](https://github.com/Itz-Abhishek-Tiwari) |
| [![Ever Blushing](https://placehold.co/180x50/141b1e/67b0e8?text=Ever+Blushing&font=Oswald)](https://github.com/rishav12s/Ever-Blushing)                              | Ever-Blush से प्रेरित डार्क एस्थेटिक मिनिमल थीम                                  | [rishav12s](https://github.com/rishav12s)                     |
| [![Crimson Blade](https://placehold.co/180x50/082451/D32D6B?text=Crimson+Blade&font=Oswald)](https://github.com/cyb3rgh0u1/Crimson-Blade)                             | तीव्र सुंदरता का मिश्रण, गहरे रंगों के साथ अंधकार को चीरता है                          | [cyb3rgh0u1](https://github.com/cyb3rgh0u1)                   |
| [![One Dark](https://placehold.co/180x50/1E212B/5B6B76?text=One+Dark&font=Oswald)](https://github.com/RAprogramm/HyDe-Themes/tree/One-Dark)                           | One Dark पर आधारित थीम                                                              | [RAprogramm](https://github.com/RAprogramm)                   |
| [![Graphite Mono](https://placehold.co/180x50/222222/D9D9D9?text=Graphite+Mono&font=Oswald)](https://github.com/HyDE-Project/hyde-themes/tree/Graphite-Mono)          | आधिकारिक थीम                                                        | [prasanthrangan](https://github.com/prasanthrangan)           |
| [![Rain Dark](https://placehold.co/180x50/1E2233/822195?text=Rain+Dark&font=Oswald)](https://github.com/rishav12s/Rain-Dark)                                          | HyDE के लिए आरामदायक नई Rain पर आधारित थीम                                                | [rishav12s](https://github.com/rishav12s)                     |
...
\*अधिक जानकारी के लिए देखें [HyDE-project/hyde-themes](https://github.com/HyDE-project/hyde-themes)।

## उपयोग

> - सुनिश्चित करें कि आपने [HyDE](https://github.com/HyDE-project/hyde) इंस्टॉल किया हुआ है
...
HyDE अभी CLI का उपयोग नहीं करता, इसलिए स्क्रिप्ट्स को मैन्युअली चलाना होगा। भविष्य में CLI भी `theme.import.py` और `theme.patch.sh` का उपयोग करेगा, इसलिए कोई बड़ी API बदलाव की संभावना नहीं है।
...
```shell
theme.patch.sh "थीम-नाम" "/पथ/से/कॉन्फ़िग्स"
theme.patch.sh "थीम-नाम" "https://github.com/User/Repository"
theme.patch.sh "थीम-नाम" "https://github.com/User/Repository/tree/branch"
```
...
:::tip
📢 अगर किसी थीम का संग्रह अपडेट हुआ हो, तो Gtk, आइकॉन्स, कर्सर और फॉन्ट को अपडेट करने के लिए `FORCE_THEME_UPDATE=true` एक्सपोर्ट करें:
...
आप अपने स्थानीय थीम्स को `theme.import.py` स्क्रिप्ट से प्राप्त या अपडेट कर सकते हैं।

<details>
<summary>सभी थीम प्राप्त करें</summary>
 यह कमांड `xdg_config/hyde/themes/` में मौजूद सभी थीम्स को अपडेट करता है जो [HyDe-gallery](#theme-gallery) में सूचीबद्ध हैं:
...
<details>
<summary>एक विशिष्ट थीम प्राप्त करें</summary>
 यह कमांड एक विशेष थीम को अपडेट करता है जो `xdg_config/hyde/themes/` में स्थित है और [HyDe-gallery](#theme-gallery) में सूचीबद्ध है:

```bash
theme.import.py --fetch "थीम-नाम"
```
